...
if($InstallationFlag){
    ...
    Invoke-InstallerScript -PSHostPath $PSHostPath -ScriptPath "$Serverip\Daten\Prog\InstallationScripts\Installation\GitInstall.ps1" -PassInstallationFlag
...
elseif($Install -eq $true){
    ...
    Invoke-InstallerScript -PSHostPath $PSHostPath -ScriptPath "$Serverip\Daten\Prog\InstallationScripts\Installation\GitInstall.ps1"
