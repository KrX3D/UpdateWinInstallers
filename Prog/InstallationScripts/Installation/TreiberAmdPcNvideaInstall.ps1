...
Write_LogEntry -Message ("Config Datei wird angepasst und Benachrichtigung für Prämien wird deaktiviert.") -Level "INFO"
$configPath = 'C:\ProgramData\NVIDIA Corporation\NVIDIA App\NvBackend\config.xml'

$content = [System.IO.File]::ReadAllText($configPath)
$content = [regex]::Replace(
    $content,
    "<Setting name='ShowRewardsNotification' value='1' />",
    "<Setting name='ShowRewardsNotification' value='0' />"
)
