...
if ($InstallationFlag) {
    ...
    Invoke-InstallerScript -PSHostPath $PSHostPath -ScriptPath "$Serverip\Daten\Prog\InstallationScripts\Installation\KicadInstallation.ps1" -PassInstallationFlag
    ...
    Invoke-InstallerScript -PSHostPath $PSHostPath -ScriptPath "$Serverip\Daten\Prog\InstallationScripts\Installation\KicadInstallation.ps1"
